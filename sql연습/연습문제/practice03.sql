...
select a.emp_no, concat(a.first_name, ' ', a.last_name) as "Full Name",
 salary as "연봉"
...
select a.emp_no, concat(a.first_name, ' ', a.last_name), d.salary,
e.title, c.dept_name
...
-- 합니다.
select a.emp_no, concat(a.first_name, ' ', a.last_name) as "이름", b.to_date
from employees a, titles b
where a.emp_no = b.emp_no
and b.to_date < now()
...
select c.dept_name, avg(d.salary) as "평균연봉"
